        ...
        <section class="panel">
            ...
            <div class="panel-body">
                <?php if(isset($_POST['change_user'])){
                    ...
                    $id=$_SESSION['id'];
                    $change_user = mysqli_query($link,"UPDATE user SET name_user='$name', username='$username',  password='$password' WHERE id_user='$id'") or die(mysqli_error());
                    if($change_user){
                ...
                <?php
                    $id=$_SESSION['id'];
                    $user = mysqli_query($link,"SELECT * FROM user WHERE id_user='$id'") or die(mysql_error());
                ...
                <form accept="" method="post">
                    ...
                    <div align="center"><button type="submit" class="btn btn-success" name="change_user">Guardar</button></div>
                </form>  
            </div>
        </section>
    </div>
